...
class SearchService:
    ...
    def search(self, query: str, num_candidates: int = 100, limit: int = 10, threshold: float = 0.9) -> list:
        query_embedding = self.embedder.embed(query)
        results = self.vector_db.search(query_embedding, num_candidates=num_candidates, limit=limit, threshold=threshold)
        ...
        for result in results:
            ...
            aggregated_results[filename]["highlights"].append(result['document']['text'])
